...
class PowerUp {
  ...
  show() {
    ...
    // green power-up
    else if (this.type == 2) fill(0, 0, 255);
    // blue power-up
    else if (this.type == 3) fill(255, 165, 0);
    // orange power-up
    else if (this.type == 4) fill(156, 39, 176); // purple power-up
    rect(this.x, this.y, this.width, this.height);
  }
  ...
  checkCollision(paddle, i) {
    // check if the power-up has collided with the paddle
    if (
